...
//
	...
	if(paused && !MenuActive && !askforquit)
	{
		...
		else
		{
			...
			ir_draw_patch_num(160, 70, W_GetNumForName("PAUSED"), PU_CACHE);
		}
	}
...
void D_PageDrawer(void)
{
	...
	ir_draw_sreen_num(W_GetNumForName(pagename), PU_CACHE);
	if(demosequence == 1)
	{
		//V_DrawPatch(4, 160, W_CacheLumpName("ADVISOR", PU_CACHE));
		ir_draw_patch_num(4, 160, W_GetNumForName("ADVISOR"), PU_CACHE);
	}
